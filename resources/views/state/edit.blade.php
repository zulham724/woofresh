				...
				<div class="card-body"> 
					{{ Form::open(['route'=>['states.update',$state->id],'method'=>'patch']) }}
						<div class="form-group">
							<label>Nama</label>
							<input type="text" class="form-control" name="name" placeholder="tulis disini" value="{{ $state->name }}" required> 
						</div>
						<div class="form-group">
							<label>Deskripsi</label>
							<textarea type="text" class="form-control" name="description" placeholder="tulis disini" value="{{ $state->description }}"> </textarea>
						</div> 
