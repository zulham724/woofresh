			...
			<div class="card">
				...
				<div class="card-body"> 
					...
					<div class="form-group">
						...
						<textarea type="text" class="form-control" value="{{ $supplier->description }}" name="description" placeholder="type something" required> </textarea>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" value="{{ $supplier->phone_number }}" name="phone_number" placeholder="type something" required> 
					</div> 
