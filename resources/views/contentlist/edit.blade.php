...
<div class="container">
	{{ Form::open(['route'=>['contentlists.update',$contentlist->id],'method'=>'put','files'=>true]) }}
	<div class="row">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body"> 
						<div class="form-group">
							...
							<input type="text" class="form-control" name="name" value="{{ $contentlist->name }}" placeholder="type something">
						</div>
						<div class="form-group">
							<label>Description</label>
							<textarea class="form-control" placeholder="type something" name="description">{{ $contentlist->description }}</textarea>
						</div> 
